            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="namaayah" class="col-sm-3 col-form-label">34. Nama Ayah Kandung</label>
                        <div class="col-sm-9">
                            <input type="text" name="namaayah" id="namaayah" class="form-control <?php echo ($error_namaayah !="" ? "is-invalid" : ""); ?>" placeholder="Nama Ayah Kandung" value="<?php echo $namaayah; ?>"> <span class="warning"><?php echo $error_namaayah ?></span>
                        </div>
                    </div>
                    <br>

                    <div class="form-group row">
                        <label for="tlayah" class="col-sm-3 col-form-label">35. Tahun Lahir</label>
                        <div class="col-sm-9">
                            <input type="text" name="tlayah" id="tlayah" class="form-control <?php echo ($error_tlayah !="" ? "is-invalid" : ""); ?>" placeholder="Tahun Lahir Ayah" value="<?php echo $tlayah; ?>"> <span class="warning"><?php echo $error_tlayah ?></span>
                        </div>
                    </div>
                    <br>

                    <div class="form-group row">
                        <label for="pendayah" class="col-sm-3 col-form-label ">36. Pendidikan </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="pekerayah" class="col-sm-3 col-form-label ">37. Pekerjaan </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="salaryayah" class="col-sm-3 col-form-label">Penghasilan Bulanan</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="berkebayah" class="col-sm-3 col-form-label "> Berkebutuhan Khusus </label>
                        <div class="col-sm-9">
                            <select class="col-sm-3 form-select" name="berkebayah">
                            <option value=""></option>
