            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="namaibu" class="col-sm-3 col-form-label">40. Nama Ibu Kandung</label>
                        <div class="col-sm-9">
                            <input type="text" name="namaibu" id="namaibu" class="form-control <?php echo ($error_namaibu !="" ? "is-invalid" : ""); ?>" placeholder="Nama Ibu Kandung" value="<?php echo $namaibu; ?>"> <span class="warning"><?php echo $error_namaibu ?></span>
                        </div>
                    </div>
                    <br>

                    <div class="form-group row">
                        <label for="tlibu" class="col-sm-3 col-form-label">41. Tahun Lahir</label>
                        <div class="col-sm-9">
                            <input type="text" name="tlibu" id="tlibu" class="form-control <?php echo ($error_tlibu !="" ? "is-invalid" : ""); ?>" placeholder="Tahun Lahir Ibu" value="<?php echo $tlibu; ?>"> <span class="warning"><?php echo $error_tlibu ?></span>
                        </div>
                    </div>
                    <br>

                    <div class="form-group row">
                        <label for="pendibu" class="col-sm-3 col-form-label ">42. Pendidikan </label>
                        <div class="col-sm-9">
                            <select class="col-sm-3 form-select" name="pendibu">
                            <option value=""></option>
                    ...
                    <div class="form-group row">
                        <label for="pekeribu" class="col-sm-3 col-form-label ">43. Pekerjaan </label>
                        <div class="col-sm-9">
                            <select class="col-sm-3 form-select" name="pekeribu">
                            <option value=""></option>
                    ...
                    <div class="form-group row">
                        <label for="salaryibu" class="col-sm-3 col-form-label">44. Penghasilan Bulanan</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="berkebibu" class="col-sm-3 col-form-label ">45. Berkebutuhan Khusus </label>
                        <div class="col-sm-9">
                            <select class="col-sm-3 form-select" name="berkebibu">
                            <option value=""></option>
